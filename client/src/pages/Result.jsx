        ...
        <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
            ...
            <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div>
                     ...
                     <img src={assets.image_wo_bg} alt="" className='rounded-md border border-gray-300
            ...
            <div className='flex justify-center sm:justify-end items-center
             flex-wrap gap-4 mt-6'>
                ...
                <a href="#" className='inline-flex gap-3 px-8 py-3.5 rounded-full  cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 
